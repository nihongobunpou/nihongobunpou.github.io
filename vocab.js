...
[
	...
	module: "2.1",
	vocab: [
		{type: "", plain: "いく", english: "to go"},
		{type: "", plain: "のむ", english: "to drink"},
		{type: "", plain: "かえる", english: "to go back"},
		{type: "", plain: "はなす", english: "to speak"},
		{type: "", plain: "きく", english: "to listen"},
		{type: "", plain: "よむ", english: "to read"},
		{type: "", plain: "おきる", english: "to get up"},
		{type: "", plain: "ねる", english: "to sleep; go to bed"},
		{type: "", plain: "たべる", english: "to eat"},
		{type: "", plain: "みる", english: "to watch; look; see"},
		{type: "", plain: "あびる", english: "to take (a shower)"},
		{type: "", plain: "する", english: "to do"},
		{type: "", plain: "べんきょうする", english: "to study"},
		{type: "", plain: "くる", english: "to come"},
	...
	module: "4.3",
	vocab: [
		{type: "", plain: "およぐ", english: "to swim"},
		{type: "", plain: "きく", english: "to ask"},
		{type: "", plain: "あそぶ", english: "to play; to spend time pleasantly"},
		{type: "", plain: "はいる", english: "to enter"},
		{type: "", plain: "けす", english: "to turn off; to erase"},
		{type: "", plain: "すわる", english: "to sit down"},
		{type: "", plain: "たばこをすう", english: "to smoke"},
		{type: "", plain: "てつだう", english: "to help"},
		{type: "", plain: "あるく", english: "to walk"},
		{type: "", plain: "やすむ", english: "1) to be absent from 2) to rest"},
		{type: "", plain: "のる", english: "to ride; to board"},
		{type: "", plain: "やる", english: "to do; to perform"},
		{type: "", plain: "いそぐ", english: "to hurry"},
		{type: "", plain: "かえす", english: "to return (a thing)"},
		{type: "", plain: "しぬ", english: "to die"},
		{type: "", plain: "つかう", english: "to use"},
		{type: "", plain: "もつ", english: "to carry; to hold"},
		{type: "", plain: "はしる", english: "to run"},
		{type: "", plain: "でかける", english: "to go out"},
		{type: "", plain: "おしえる", english: "to teach; to instruct"},
		{type: "", plain: "かりる", english: "to borrow"},
		{type: "", plain: "つける", english: "to turn on"},
		{type: "", plain: "わすれる", english: "to forget"},
		{type: "", plain: "あける", english: "to open (something)"},
		{type: "", plain: "おりる", english: "to get off"},
		{type: "", plain: "でんわをかける", english: "to make a phone call"},
		{type: "", plain: "つれてくる", english: "to bring (a person)"},
		{type: "", plain: "もってくる", english: "to bring (a thing)"},
		{type: "", plain: "たつ", english: "to stand up"},
		{type: "", plain: "しめる", english: "to close"}
	]
	},
	{
	...
	vocab: [
		...
		{type: "", plain: "うたう", english: "to sing (a song)"},
		{type: "", plain: "かぶる", english: "to put on (a hat)"},
		{type: "", plain: "しる", english: "to get to know"},
		{type: "", plain: "すむ", english: "to live"},
		{type: "", plain: "はく", english: "to put on (items below your waist)"},
		{type: "", plain: "ふとる", english: "to gain weight"},
		{type: "", plain: "とる", english: "to take (a class/grade)"},
		{type: "", plain: "めがねをかける", english: "to put on glasses"},
		{type: "", plain: "きる", english: "to put on (clothes above your waist)"},
		{type: "", plain: "つとめる", english: "to work for"},
		{type: "", plain: "やせる", english: "to lose weight"},
		{type: "", plain: "けっこんする", english: "to get married"},
	...
	vocab: [
		...
		{type: "", plain: "あらう", english: "to wash"},
		{type: "", plain: "いう", english: "to say"},
		{type: "", plain: "いる", english: "to need"},
		{type: "", plain: "おそくなる", english: "to be late"},
		{type: "", plain: "おもう", english: "to think"},
		{type: "", plain: "きる", english: "to cut"},
		{type: "", plain: "つくる", english: "to make"},
		{type: "", plain: "もっていく", english: "to take (a thing)"},
		{type: "", plain: "じろじろみる", english: "to stare at"},
		{type: "", plain: "すてる", english: "to throw away"},
		{type: "", plain: "こたえる", english: "to answer (a question)"},
		{type: "", plain: "はじめる", english: "to start"},
		{type: "", plain: "つかれる", english: "to get tired"},
		{type: "", plain: "つかれている", english: "to be tired"},
		{type: "", plain: "うんてんする", english: "to drive"},
		{type: "", plain: "せんたくする", english: "to do laundry"},
		{type: "", plain: "そうじする", english: "to get clean"},
		{type: "", plain: "でんわする", english: "to call"},
		{type: "", plain: "りょうりする", english: "to cook"},
		{type: "", plain: "しごと(を)する", english: "to work; to do job"},
		{type: "", plain: "しつもんする", english: "to ask a question"},
		{type: "", plain: "もってくる", english: "to bring (a thing)"},
	...
	vocab: [
		...
		{type: "", plain: "にんきがある", english: "to be popular"},
		{type: "", plain: "もらう", english: "to get (from somebody)"},
		{type: "", plain: "ひく", english: "to play string instruments"},
		{type: "", plain: "ふく", english: "to play wind instruments"},
		{type: "", plain: "たたく", english: "to play percussion instruments"},
		{type: "", plain: "おぼえる", english: "to memorize"},
		{type: "", plain: "（に）でる", english: "to appear to attend"},
		{type: "", plain: "（を）でる", english: "to exit"},
		{type: "", plain: "うんどうする", english: "to do physical exercises"},
		{type: "", plain: "はなしをする", english: "to tell a story, to have a talk"},
	...
	module: "4.1",
	vocab: [
		{type: "", plain: "かかる", english: "to take (amount of time/money)"},
		{type: "", plain: "とまる", english: "to stay (at a hotel, etc)"},
		{type: "", plain: "うる", english: "to sell"},
		{type: "", plain: "はらう", english: "to pay"},
		{type: "", plain: "なる", english: "to become"},
		{type: "", plain: "としをとる", english: "to age"},
		{type: "", plain: "うそをつく", english: "to tell a lie"},
		{type: "", plain: "ならう", english: "to learn"},
		{type: "", plain: "おなかがすく", english: "to become hungry"},
		{type: "", plain: "のぼる", english: "to climb"},
		{type: "", plain: "かう", english: "to own (a pet)"},
		{type: "", plain: "はたらく", english: "to work"},
		{type: "", plain: "サボる", english: "to cut (classes)"},
		{type: "", plain: "きめる", english: "to decide"},
		{type: "", plain: "やめる", english: "to quit"},
		{type: "", plain: "うける", english: "to take a test, quiz, exam, etc."},
		{type: "", plain: "りょこうする", english: "to travel"},
		{type: "", plain: "よやくする", english: "to make a reservation"},
		{type: "", plain: "れんしゅうする", english: "to practice"},
		{type: "", plain: "けんかする", english: "to have a fight; to quarrel"},
		{type: "", plain: "しょうかいする", english: "to introduce"},
		{type: "", plain: "ちこくする", english: "to be late"},
		{type: "", plain: "ダイエットする", english: "to go on a diet"},
		{type: "", plain: "りゅうがくする", english: "to study abroad"},
	...
	module: "5.1",
	vocab: [
		{type: "", plain: "かぜをひく", english: "to catch a cold"},
		{type: "", plain: "ねつがある", english: "to have a fever"},
		{type: "", plain: "きょうみがある", english: "to be interested in"},
		{type: "", plain: "のどがかわく", english: "to become thirsty"},
		{type: "", plain: "なくす", english: "to lose"},
		{type: "", plain: "せきがでる", english: "to cough"},
		{type: "", plain: "わかれる", english: "to break up; to separate"},
		{type: "", plain: "がんばる", english: "to do one's best; try hard"},
		{type: "", plain: "なく", english: "to cry"},
		{type: "", plain: "きんちょうする", english: "to get nervous"},
		{type: "", plain: "しんぱいする", english: "to worry"},
		{type: "", plain: "けがをする", english: "to get injured"},
		{type: "", plain: "かんどうする", english: "to be moved/touched"},
